  ...
  return (
    <>
      <div className="h-full flex flex-col justify-between gap-2">
        <div className="md:h-[640px] xxl:h-[410px] xxx:h-[340px] xss:h-[375px] h-[400px] overflow-y-auto">
          <div className="grid md:grid-cols-2 grid-cols-1 gap-3">
          {sortedFoodDetail.length === 0 ? (
              <div className="flex justify-center w-full items-center col-span-2">
                <p className="text-center w-full text-[#8F8F8F] text-sm">ไม่มีรายการอาหาร</p>
              </div>
              ...
              >
                ...
                <div className="w-full flex flex-col justify-start items-center gap-2 max-md:h-auto">
                  ...
                  <div className="flex flex-row justify-between w-full gap-12 border-b border-[#8F8F8F] border-dashed pb-1 items-center">
                    ...
                    <div
                      className={`max-w-[95px] w-full flex justify-end rounded-sm p-1 items-center 
                    ${
        ...
        >
          <p className="text-white text-[25px] font-[500]" disabled={sortedFoodDetail.length === 0}>ชำระเงิน</p>
        </Link>
      </div>
    </>
  );
